...
from .const import DOMAIN, DOMAIN_DATA, ICON_SHUTTER_CLOSED, ICON_SHUTTER_OPENED

_LOGGER = logging.getLogger(__name__)


async def async_setup_entry(hass, entry, async_add_devices):
    """Create new cover device."""
...
class InelsShutter(InelsEntity, CoverEntity):
    ...
    def __init__(self, coordinator, shutter):
        """Initialize of the InelsShutter."""
    ...
    def state(self):
        ...
        return (
            ...
            if self.device.state == STATE_OPEN
            else STATE_CLOSED
        )
