...
from .const import DOMAIN, DOMAIN_DATA, ICON_LIGHT, PLATFORM_LIGHT
...
class InelsLightDimmable(InelsLightBase, LightEntity):
    ...
    def supported_features(self):
        """Supported feature of the light. We support brightnes. In future maybe i RGB and temperature."""
